...
namespace Aula01.Domain.Validations
{
    public class CpfValidacao
    {
        ...
        private static bool TemDigitosValidos(string valor)
        {
            ...
            return string.Concat(firstDigit, secondDigit) == valor.Substring(QtdCaracterCPF - 2, 2);
        }
        ...
        public static bool ValidarTamanho (string valor)
        {
            return valor.Length == QtdCaracterCPF;
        }
    }
